    ...
    <div className="p-4">
      ...
      <div className="mb-4">
        ...
        <div className="flex items-center">
          ...
          <input type="text" value={slug} onChange={(e) => onSlugChange(e.target.value)} className="flex-grow p-2 border rounded text-sm" placeholder="your-unique-slug" disabled={isSaving || isLoading} />
        </div>
      ...
      <div className="mb-4">
        ...
        <input type="text" placeholder="yourdomain.com" value={customDomain || ""} onChange={(e) => onCustomDomainChange(e.target.value)} className="w-full p-2 border rounded text-sm" disabled={isSaving || isLoading} />
      ...
      <button onClick={onSave} disabled={isSaving || isLoading} className="w-full mt-6 inline-flex items-center justify-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50">
