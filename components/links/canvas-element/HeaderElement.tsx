    ...
    <div className="relative my-4 flex items-center justify-center gap-2 px-4">
      ...
      <Dialog.Root
        ...
        <Dialog.Trigger asChild>
          <button
            className="absolute right-4 p-1.5 text-black rounded-full opacity-60 hover:opacity-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500"
