  ...
  return (
    <motion.div
      className={`relative group my-3 ${
        isNested ? "p-2" : "p-4"
      } text-center border border-gray-200/80 dark:border-gray-700/80 shadow-sm ${radiusClass}`}
    ...
    >
      ...
      {isValidTargetDate ? (
        <div
          className="flex justify-center items-baseline space-x-2 md:space-x-4"
          style={{ color: cardTextColor }}>
          {/* Days */}
        ...
        <div
          className={`flex flex-col items-center justify-center h-24 bg-gray-100/50 dark:bg-gray-800/30 rounded-md p-4 border border-dashed border-gray-300 dark:border-gray-600 ${radiusClass}`}>
          <CalendarClock
          ...
          <Dialog.Portal>
            ...
            <Dialog.Content
              ...
              <div className="space-y-4 mb-6">
                ...
                <div>
                  <label
                    htmlFor={`countdown-title-${element.id}`}
                    className="block text-sm font-medium text-gray-700 mb-1.5">
                    Title (Optional)
                  </label>
                  <input
                    id={`countdown-title-${element.id}`}
                    type="text"
                    value={editedTitle}
                ...
                <div>
                  <label
                    htmlFor={`countdown-date-${element.id}`}
                    className="block text-sm font-medium text-gray-700 mb-1.5">
                    Target Date & Time*
                  </label>
                  <input
