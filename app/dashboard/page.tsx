...
const tutorials: Tutorial[] = [
  ...
  { id: 3, title: "Optimizing Landing Page Conversion Rates", duration: "12 min", difficulty: "Advanced", image: "/placeholder-img.svg" },
  { id: 4, title: "A/B Testing Your Email Templates", duration: "10 min", difficulty: "Intermediate", image: "/placeholder-img.svg" },
];

const recentCampaigns: Campaign[] = [
  { id: 1, name: "March Newsletter", status: "Sent", opens: 2456, clicks: 873, date: "Mar 10, 2025" },
  { id: 2, name: "Product Launch Announcement", status: "Draft", opens: 0, clicks: 0, date: "Mar 18, 2025" },
  { id: 3, name: "Spring Sale Promotion", status: "Scheduled", opens: 0, clicks: 0, date: "Mar 21, 2025" },
];
