...
export default function LandingPage() {
  ...
  const [landingPageToDelete, setLandingPageToDelete] = useState<string | null>(null);
  ...
  async function fetchLandingPagesData() {
    try {
      ...
      if (data.length > totalPagesAllowed) {
        ...
        const sortedPages = [...data].sort((a, b) => new Date(a.created_at).getTime() - new Date(b.created_at).getTime());
  ...
  const columns = [
      ...
      render: (item: any) => {
        ...
        return (
          <div>
            ...
            {item.domain.status && <Badge variant={item.domain.status === "verified" ? "success" : "secondary"}>{item.domain.status}</Badge>}
          </div>
        );
      },
    },
    {
      key: "isactive",
      label: "Status",
      render: (item: any) => <Badge variant={item.isactive ? "default" : "secondary"}>{item.isactive ? "Published" : "Draft"}</Badge>,
    },
    {
      key: "visits",
      label: "Visits",
      ...
      render: (item: any) => (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem onClick={() => window.open(`/landing/${item.id}`, "_blank")}>
            ...
            <DropdownMenuItem onClick={() => router.push(`/dashboard/landing/edit?id=${item.id}`)}>
  ...
  async function deleteLandingPage(id: string) {
    try {
      ...
      setLandingPages((prevForms) => prevForms.filter((form) => form.id !== id));
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8">
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                    ...
                    <div className="grid gap-4 py-4 md:grid-cols-2 lg:grid-cols-3">
                      ...
                      <Card
                        ...
                        <CardHeader>
                          ...
                          <CardDescription>Start from scratch with a blank landing page</CardDescription>
                        </CardHeader>
                      </Card>
                    </div>
                  </DialogContent>
                ...
                <Button
                  ...
                  variant={usedPages >= totalPagesAllowed ? "outline" : "default"}>
                  <Plus className="mr-2 h-4 w-4" />
                  {usedPages >= totalPagesAllowed ? "Page Limit Reached" : "Create New Landing Page"}
                </Button>
              </div>
            </div>
                ...
                <CardDescription className="text-gray-600">
                  ...
                  {usedPages === totalPagesAllowed && (
                    <span className="text-amber-600 mt-1 text-sm block">
                      You've reached your plan limit. Oldest pages are preserved if you exceed this limit.
                    </span>
                  )}
                </CardDescription>
                <Progress
            ...
            <Card className="bg-white border-none shadow-sm rounded-lg p-4">
              <CardHeader>
                <CardTitle className="text-gray-900 text-xl">Your Landing Pages</CardTitle>
              </CardHeader>
              <CardContent>
                <DataTable
                  data={LandingPages || []}
            ...
            <Dialog
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>Use the link below to share the landing page or generate its QR code.</DialogDescription>
                </DialogHeader>
                ...
                {shortUrlError && <p className="text-sm text-red-500 mt-1">{shortUrlError}</p>}
            ...
            <Dialog
              ...
              <DialogContent className="max-w-5xl h-[80vh]">
                <DialogHeader>
                  ...
                  <DialogDescription>Preview how your landing page will appear to visitors</DialogDescription>
                </DialogHeader>
                <div className="flex-1 overflow-auto mt-4 border rounded-md">{previewContent && <LandingPreview content={previewContent} />}</div>
                <DialogClose asChild>
                  <Button
                    variant="ghost"
                    className="mt-4 w-full">
            ...
            <Dialog
              ...
              <DialogContent className="max-w-3xl max-h-[70vh] overflow-hidden flex flex-col">
                <DialogHeader className="flex-shrink-0">
                  ...
                  <DialogDescription>Configure the domain settings for your landing page</DialogDescription>
                </DialogHeader>
                {selectedLandingPage && (
            ...
            <Dialog
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>You have used all 10 free landing pages available on your current plan.</DialogDescription>
                </DialogHeader>
            ...
            <Dialog
              ...
              <DialogContent className="sm:max-w-md">
                <DialogHeader>
                  ...
                  <DialogDescription>Are you sure you want to delete this landing page? This action cannot be undone.</DialogDescription>
                </DialogHeader>
                <div className="flex justify-end gap-2 mt-4">
                  ...
                  <Button
                    variant="destructive"
                    onClick={() => landingPageToDelete && deleteLandingPage(landingPageToDelete)}>
                    Delete
                  </Button>
                </div>
              </DialogContent>
